...
type Device struct {
	...
	// UnavailableReason 设备恢复使用综合判定说明：列出仍缺失的条件（维修/计量）。
	UnavailableReason   string     `gorm:"size:512" json:"unavailable_reason"`
	...
	LastRecoverCheckAt  *time.Time `json:"last_recover_check_at"`
